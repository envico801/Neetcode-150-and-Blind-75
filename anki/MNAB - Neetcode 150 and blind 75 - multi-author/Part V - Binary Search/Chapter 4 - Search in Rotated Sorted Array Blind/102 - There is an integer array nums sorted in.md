...
If we are in the left sorted half of the array, but the target element belongs
in the right sorted half, where should we search relative to the mid pointer?
...
If we are in the left sorted half of the array, but the target element belongs
to the right sorted half, we should continue our search to the right of the mid
pointer.
...
FILE TAGS: #DSA::#Leetcode::#MNAB-Neetcode-150-and-blind-75-multi-author::#Part-V-Binary-Search::#Chapter-4-Search-in-Rotated-Sorted-Array-Blind::#102-There-is-an-integer-array-nums-sorted-in
