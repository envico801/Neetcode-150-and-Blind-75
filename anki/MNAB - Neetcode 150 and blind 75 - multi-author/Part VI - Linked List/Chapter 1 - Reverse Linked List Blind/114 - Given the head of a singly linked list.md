...
If we have a linked list with only one node, what will be the result after
reversing it?
...
Reversing a linked list with only one node doesn't change anything. It remains
the same, as there are no other nodes to rearrange.
...
FILE TAGS: #DSA::#Leetcode::#MNAB-Neetcode-150-and-blind-75-multi-author::#Part-VI-Linked-List::#Chapter-1-Reverse-Linked-List-Blind::#114-Given-the-head-of-a-singly-linked-list
